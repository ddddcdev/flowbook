...
def _upsert_result(
    ...
    warnings: check_warn etc. step warnings; merged into meta when non-empty."""
    merged_meta = meta if meta is not None else {}
    if warnings:
        merged_meta = {**merged_meta, "warnings": list(warnings)}
