...
class UpdateConfigOp(BaseOp):
    ...
    def __call__(self, inputs: dict[str, Any], store: RunStore) -> dict[str, Any]:
        ...
        store.configs.put_spec(spec_type, inp.config_name, inp.spec, config_id=config_id)

        return self.Outputs(
            config_id=config_id, config_type=inp.config_type, config_name=inp.config_name
