...
Spec dict shape per kind: see flowbook.configs.spec_types.
"""
...
from flowbook.configs.spec_types import ConfigSpecKind
...
class ConfigStore(Protocol):
    ...
    def get_spec(
        self, spec_type: type[TSpecKind], name: str
    ) -> TSpecKind.Spec:  # type: ignore[type-var]
